...
inline constexpr const char* kAdventAssetsPath = "/mnt/us/extensions/kindle-dashboard/assets/advent";
inline constexpr const char* kAdventAssetsLocalPath = "kindle/kual/kindle-dashboard/assets/advent";
inline constexpr const char* kAdventStatePath = "/mnt/us/extensions/kindle-dashboard/advent-state.txt";
inline constexpr int kAdventDays = 24;
